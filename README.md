...
```
download zip
copy 'vue-ssr' to application's packages directory
meteor add agile:vue-ssr
```
...
This is based on https://github.com/Akryum/meteor-vue-component
3 small changes made in order to use https://github.com/Meteor-Community-Packages/meteor-fast-render instead of https://github.com/abecks/meteor-fast-render
